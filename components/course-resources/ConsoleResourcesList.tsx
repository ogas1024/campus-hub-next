        ...
        <CardContent>
          <form className="grid gap-3 md:grid-cols-12" action={props.basePath} method="GET">
            ...
            <div className="md:col-span-3">
              <Select name="majorId" defaultValue={majorId ?? ""}>
            ...
            <div className="md:col-span-3">
              <Select name="courseId" defaultValue={courseId ?? ""} disabled={!props.canCourseList}>
            ...
            <div className="md:col-span-4">
              <Input name="q" placeholder="搜索标题…" defaultValue={q} />
            </div>
