...
> 本文已拆分为以下文档（后续新增/变更请更新这些文档）：
> - 身份与访问控制（IAM）：`docs/requirements/iam.md`
> - 组织与岗位：`docs/requirements/organization.md`
> - 数据范围与数据权限：`docs/requirements/data-permission.md`
> - 审计日志：`docs/requirements/audit.md`
...
*说明：本文为历史拆分稿，已由 `docs/requirements/iam.md` / `organization.md` / `data-permission.md` / `audit.md` 替代，不再作为单一事实来源。*
