...
export default async function ConsoleResourcesPublishedPage({ searchParams }: { searchParams: Promise<SearchParams> }) {
  ...
  return (
    <ConsoleResourcesList
      actorUserId={user.id}
      title="已发布"
      description="仅显示 published；可下架；可设置/取消最佳；硬删除仅 admin/super_admin。"
      fixedStatus="published"
      basePath="/console/resources/published"
      searchParams={sp}
      canReview={canReview}
