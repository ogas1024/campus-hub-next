...
function buildHref(params: { q?: string; type?: string; page?: number; pageSize?: number }) {
  ...
  return qs ? `/console/lostfound/rejected?${qs}` : "/console/lostfound/rejected";
}

export default async function ConsoleLostfoundRejectedPage({ searchParams }: { searchParams: Promise<SearchParams> }) {
    ...
    <div className="space-y-4">
      ...
      <Card>
        <CardContent className="p-4">
          <form className="grid gap-3 md:grid-cols-12" action="/console/lostfound/rejected" method="GET">
            ...
            <div className="flex flex-wrap gap-2 md:col-span-12">
              <Link className={buttonVariants({ variant: "outline", size: "sm" })} href="/console/lostfound/rejected">
                清空
              </Link>
              ...
              <tr key={item.id} className="border-t border-border">
                ...
                <td className="px-3 py-3 text-right">
                  <ConsoleLostfoundActions
                    ...
                    canDelete={canDelete}
                    compact
                    afterDeleteHref="/console/lostfound/rejected"
                  />
                </td>
              </tr>
            ))}
